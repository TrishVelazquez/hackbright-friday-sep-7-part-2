...
def sort_by_cohort(filename):
    ...
    for line in file:
        ...
        first_name, last_name, _, _, cohort = line.split("|")

        # print (first_name + ' ' + last_name, cohort)
        if cohort == "I":
            continue
        elif cohort == "Winter 2016":
            cohort_list = winter_16
        elif cohort == "Spring 2016":
            cohort_list = spring_16
        elif cohort == "Summer 2016":
            cohort_list = summer_16
        ...
        cohort_list.append(first_name + ' ' + last_name)
...
def hogwarts_by_house(filename):
    ...
    house_idx = ("Dumbledore's Army", "Gryffindor", "Hufflepuff", "Ravenclaw", "Slytherin", "")
    ...
    for line in file:
        ...
        _, last_name, house, _, cohort = line.split("|")
        ...
        if cohort=="G":
            ...
            x = house_idx.index(house)
            all_hogwarts[x].append(last_name)
...
def all_students_tuple_list(filename):
    ...
    for line in file:
        ...
        if house:
            student_list.append(tuple([first + ' ' + last, house, advisor, cohort]))
